...
//    @ModStringProvider(M_CURRENT)
    ...
    protected void fillDiffCI(AbstractCI newCI, AbstractCI diffCI) {
        ...
        {
            String value = newCastedCI.getPolicy();
            if (value != null && !value.equals(getPolicy()))
                diffCastedCI.setPolicy(value);
        }{
            String value = newCastedCI.getState();
            if (value != null && !value.equals(getState()))
                diffCastedCI.setState(value);
        }{
