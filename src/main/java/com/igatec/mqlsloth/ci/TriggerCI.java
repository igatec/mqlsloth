...
public class TriggerCI extends AdminBusCI {
    ...
    public final static String BUS_TYPE = M_TRIGGER_INPUT;
    public final static String BUS_POLICY = "eService Trigger Program Policy";
    public final static String STATE_ACTIVE = "Active";
    public final static String STATE_INACTIVE = "Inactive";

    public final static String ATTR_ERROR_TYPE = "eService Error Type";
    private final static String ATTR_ERROR_TYPE_DEFAULT_VALUE = "Error";
    public final static String ATTR_PROGRAM_NAME = "eService Program Name";
    public final static String ATTR_METHOD_NAME = "eService Method Name";
    public final static String ATTR_CONSTRUCTOR_ARGUMENTS = "eService Constructor Arguments";
    public final static String ATTR_SEQUENCE_NUMBER = "eService Sequence Number";
    public final static String ATTR_TARGET_STATES = "eService Target States";

    public final static String ATTR_PROGRAM_ARG_PREFIX = "eService Program Argument ";
    public final static String ATTR_PROGRAM_ARG_DESC_PREFIX = "eService Program Argument Desc ";

    private final static Set<Integer> ALL_ARGS_INDEXES;
    private final static Set<String> ALL_ATTRS;

    private final static int FIRST_ARG = 1;
    private final static int LAST_ARG = 1;
