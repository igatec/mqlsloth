...
public class DiffExecutor extends AbstractExecutor {
    ...
    private final static String DIFF_ARGS_ERROR = "Diff task must have argument 's' or 't' defining which location (source or target) would be search condition applied to";
    private final static String DIFF_ARGS_T = "t";
    private final static String DIFF_ARGS_S = "s";
