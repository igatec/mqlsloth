...
public class ObjectGeneratorObjectParser extends AbstractBusObjectParser {
    public ObjectGeneratorObjectParser(Format format) {
        super(format);
    }
    ...
    protected AbstractCI createObject(Map<String, Object> fieldsValues) throws ParserException {
        ...
        if (name == null) {
            throw new ParserException("Can't create " + M_OBJECT_GENERATOR + ". Name not found");
        }
